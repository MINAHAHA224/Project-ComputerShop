<%-- src/main/webapp/WEB-INF/view/client/about/show.jsp --%> <%@ page
...
<html lang="${pageContext.response.locale.language}">
  <head>
    ...
    <meta content="
    <spring:message code="page.about.meta.keywords" />
    " name="keywords"/> <meta content="
    <spring:message code="page.about.meta.description" />
    " name="description"/>
  ...
  <body>
    ...
    <div class="container-fluid page-header about-page-header py-5">
      <div class="container text-center">
        <h1 class="text-white animated slideInDown">
          <spring:message code="page.about.header.title" />
        </h1>
      ...
      <div class="container">
        <div class="row align-items-center g-5">
          <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
            <spring:message
              code="page.about.story.alt.storyImage"
              var="storyImageAlt"
            />
            <img
          ...
          <div class="col-lg-6 wow fadeIn text-content" data-wow-delay="0.5s">
            <h4 class="section-title">
              <spring:message code="page.about.story.sectionTitle" />
            </h4>
            ...
            <a
              ...
              ><spring:message code="page.about.story.button.exploreProducts"
            /></a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-6 wow fadeIn text-content" data-wow-delay="0.1s">
            <h4 class="section-title">
              <spring:message code="page.about.development.sectionTitle" />
            </h4>
            <h2 class="section-main-title mb-4">
              <spring:message code="page.about.development.mainTitle" />
            </h2>
            <h5>
              <spring:message code="page.about.development.vision.title" />
            </h5>
            <p><spring:message code="page.about.development.vision.text" /></p>
            <h5 class="mt-4">
              <spring:message code="page.about.development.mission.title" />
            </h5>
            <p><spring:message code="page.about.development.mission.text" /></p>
          </div>
          <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
            <spring:message
              code="page.about.development.alt.visionImage"
              var="visionImageAlt"
            />
            <img
    ...
    <div class="container-fluid section-padding">
      <div class="container">
        ...
        >
          <h4 class="section-title">
            <spring:message code="page.about.coreValues.sectionTitle" />
          </h4>
          <h2 class="section-main-title mb-5">
            <spring:message code="page.about.coreValues.mainTitle" />
          </h2>
        </div>
        <div class="row g-4 justify-content-center">
          <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s">
            <div class="value-item">
              ...
              <h5>
                <spring:message code="page.about.coreValues.quality.title" />
              </h5>
              <p>
                <spring:message code="page.about.coreValues.quality.text" />
              </p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
            <div class="value-item">
              ...
              <h5>
                <spring:message code="page.about.coreValues.trust.title" />
              </h5>
          ...
          <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.6s">
            <div class="value-item">
              ...
              <h5>
                <spring:message code="page.about.coreValues.dedication.title" />
              </h5>
              <p>
                <spring:message code="page.about.coreValues.dedication.text" />
              </p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.8s">
            <div class="value-item">
              ...
              <h5>
                <spring:message code="page.about.coreValues.innovation.title" />
              </h5>
              <p>
                <spring:message code="page.about.coreValues.innovation.text" />
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container py-4">
        <div class="wow fadeInUp" data-wow-delay="0.1s">
          ...
          <a
            ...
            ><spring:message code="page.about.cta.button.viewLaptops"
          /></a>
          <a
            href="<c:url value='/contact-us'/>"
            class="btn btn-light text-primary rounded-pill py-3 px-5"
            ><spring:message code="page.about.cta.button.contactSupport"
          /></a>
        </div>
        ...
        <c:if
          test="${not empty param.messageSuccess || not empty messageSuccess}"
        >
          <div
