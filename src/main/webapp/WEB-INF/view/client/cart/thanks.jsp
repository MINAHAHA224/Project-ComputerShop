...
<%--    <jsp:include page="../layout/common_head.jsp"/> &lt;%&ndash; Giả sử bạn có file này cho common head &ndash;%&gt;--%>
...
<div class="container-fluid py-5">
    <div class="container py-5 thank-you-container">
        ...
        <hr>
        <p>
            Gặp vấn đề? <a href="/contact">Liên hệ chúng tôi</a>
        </p>
        <p class="lead">
...
<%--<jsp:include page="../layout/common_scripts.jsp"/> &lt;%&ndash; Giả sử bạn có file này cho common scripts &ndash;%&gt;--%>
