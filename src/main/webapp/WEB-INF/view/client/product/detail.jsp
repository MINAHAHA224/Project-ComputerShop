...
<div class="container-fluid page-header py-5">
    ...
    <ol class="breadcrumb justify-content-center mb-0">
        <li class="breadcrumb-item"><a href="<c:url value='/'/>"><spring:message code="page.productDetail.breadcrumb.home"/></a></li>
            ...
            <div class="col-lg-8">
                <div class="row g-4">
                    ...
                    <div class="col-lg-7 product-details">
                        ...
                        <p class="mb-3 text-muted">${product.shortDesc}</p> <%-- Mô tả ngắn giữ nguyên --%>
