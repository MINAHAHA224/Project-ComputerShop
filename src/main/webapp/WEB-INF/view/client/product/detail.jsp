...
<!DOCTYPE html>
<html lang="vi"> <%-- Sửa lang thành vi cho tiếng Việt --%>
    ...
    <div class="container py-5">
        <div class="row g-4 mb-5">
            <div class="col-lg-8 col-xl-9">
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-3">Thương hiệu: ${product.factory}</p>
                        ...
                        <%-- Input group cho Quantity hiển thị --%>
                        <div class="input-group quantity mb-5" style="width: 120px;">
                            ...
                            <%-- Input hiển thị quantity, đặt ID cho nó --%>
                            <input type="text"
                                   id="displayQuantity"
                                   class="form-control form-control-sm text-center border-0" value="1" readonly />
                            <div class="input-group-btn">
                        ...
                        <form action="${pageContext.request.contextPath}/add-product-from-view-detail" method="post" id="addToCartForm">
                            <input class="form-control d-none" type="text" value="${product.id}" name="id" />
                            <%-- Input ẩn để gửi giá trị quantity, đặt ID cho nó --%>
                            <input class="form-control d-none" type="number" name="quantity" id="formQuantityInput" value="1" />
            ...
            <div class="col-lg-4 col-xl-3">
                <%-- ... (Phần categories, banner giữ nguyên) ... --%>
                <div class="row g-4 fruite">
                    <div class="col-lg-12">
                        <div class="input-group w-100 mx-auto d-flex mb-4">
                            <input type="search" class="form-control p-3" placeholder="keywords"
                                   aria-describedby="search-icon-1-sidebar">
                            <span id="search-icon-1-sidebar" class="input-group-text p-3"><i
                                    class="fa fa-search"></i></span>
                        </div>
                        <div class="mb-4">
                            <h4>Categories</h4>
                    ...
                    <div class="col-lg-12">
                        <div class="position-relative">
                            <img src="${pageContext.request.contextPath}/client/img/banner-fruits.jpg" class="img-fluid w-100 rounded"
                                 alt="">
