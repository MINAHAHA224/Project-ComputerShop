      ...
      <div class="card auth-card" style="max-width: 550px">
        <div class="card-header">
          <a href="<c:url value='/'/>" class="logo-text-auth"
            ><spring:message code="page.register.header.brandName"
          /></a>
          <h3 class="font-weight-light my-1">
            <spring:message code="page.register.header.title" />
          </h3>
        </div>
        ...
        <div class="card-body p-4">
          ...
          <c:if test="${not empty messageError}">
            <div class="alert alert-danger alert-auth my-3" role="alert">
              ${messageError} <%-- Nếu messageError là key, dùng
          ...
          >
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-floating mb-3 mb-md-0">
                  <spring:message
                    code="page.register.form.placeholder.firstName"
                  ...
                  <label for="inputFirstName"
                    ><spring:message code="page.register.form.label.firstName"
                  /></label>
                  <form:errors path="firstName" cssClass="form-error" /> <%--
                  Error messages từ DTO đã được dịch --%>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-floating">
                  <spring:message
                    code="page.register.form.placeholder.lastName"
                  ...
                  <label for="inputLastName"
                    ><spring:message code="page.register.form.label.lastName"
                  /></label>
            ...
            <div class="form-floating mb-3">
              <spring:message
                code="page.register.form.placeholder.email"
              ...
              <label for="inputEmail"
                ><spring:message code="page.register.form.label.email"
              /></label>
              <form:errors path="email" cssClass="form-error" /> <%-- Error
              messages từ DTO đã được dịch --%>
            </div>
            <div class="row mb-3">
              <div class="col-md-6">
                <div class="form-floating mb-3 mb-md-0">
                  <spring:message
                    code="page.register.form.placeholder.password"
                  ...
                  <label for="inputPassword"
                    ><spring:message code="page.register.form.label.password"
                  /></label>
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <spring:message
                    code="page.register.form.placeholder.confirmPassword"
                  ...
                  <label for="inputPasswordConfirm"
                    ><spring:message
                      code="page.register.form.label.confirmPassword"
                  /></label>
          ...
          <div class="divider-text my-4">
            <span><spring:message code="page.register.divider.or" /></span>
          </div>
          ...
          <div class="d-grid">
            ...
            >
              ...
              <spring:message code="page.register.button.google" />
            </a>
          </div>
        </div>
        <div class="card-footer">
          <div class="small">
            ...
            <a href="<c:url value='/login'/>" class="text-primary fw-medium"
              ><spring:message code="page.register.footer.login"
            /></a>
          </div>
        </div>
      </div>
