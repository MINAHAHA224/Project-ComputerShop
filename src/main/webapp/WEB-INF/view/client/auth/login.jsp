<%-- JSP Path: src/main/webapp/WEB-INF/view/client/auth/login.jsp --%>
...
<div class="auth-wrapper">
  <div class="card auth-card">
    <div class="card-header">
      ...
      <h3 class="font-weight-light my-1"><spring:message code="page.login.header"/></h3>
    </div>
    <div class="card-body">
      ...
      <form:form method="post" action="/login" modelAttribute="loginDTO">
        ...
        <div class="form-floating mb-3">
          ...
          />
          <label for="inputEmail"><spring:message code="page.login.label.email"/></label>
        ...
        <div class="form-floating mb-3">
          ...
          />
          <label for="inputPassword"><spring:message code="page.login.label.password"/></label>
        ...
        <div class="text-end mb-3">
          ...
          ><spring:message code="page.login.link.forgotPassword"/></a
          >
        </div>
      ...
      <div class="divider-text"><span><spring:message code="page.login.divider.or"/></span></div>
      ...
      <div class="d-grid">
        ...
        >
          <i class="fab fa-google me-2"></i><spring:message code="page.login.button.google"/>
        </a>
      </div>
    </div>
    <div class="card-footer">
      <div class="small">
        ...
        ><spring:message code="page.login.footer.registerNow"/></a
        >
      </div>
    </div>
  </div>
