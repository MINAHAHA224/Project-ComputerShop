...
<!-- JSP Path: admin/order/update.jsp -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
            ...
            <div class="mt-5">
              <div class="row">
                <div class="col-md-8 col-12 mx-auto">
                  <%-- Mở rộng cột để chứa nhiều trường hơn --%>
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      >
                        <%-- Trường ID ẩn để gửi đi khi submit, nhưng vẫn hiển
                        thị thông tin --%>
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="receiverAddress"
                          ...
                          <div class="col-md-6 mb-3">
                            ...
                            >
                              <form:option value="PENDING"
                                >Chờ xác nhận</form:option
                              >
                              <form:option value="CONFIRMED"
                                >Đã xác nhận đơn</form:option
                              >
                              <form:option value="SHIPPED"
                                >Đã giao cho bên vận chuyển</form:option
                              >
                              <form:option value="DELIVERED"
                                >Giao hàng thành công</form:option
                              >
                              <form:option value="CANCELLED"
                                >Hủy đơn hàng</form:option
                              >
                            </form:select>
                          </div>
                          <div class="col-md-6 mb-3">
                            <label class="form-label" for="statusPayment"
                            ...
                            >
                              <form:option value="UNPAID"
                                >Chưa thanh toán</form:option
                              >
                              <form:option value="PAID"
                                >Đã thanh toán</form:option
                              >
                              <form:option value="REFUNDED"
                                >Đã hoàn tiền</form:option
                              >
                              <form:option value="FAILED"
                                >Thanh toán thất bại</form:option
                              >
                            </form:select>
                          </div>
                        </div>
