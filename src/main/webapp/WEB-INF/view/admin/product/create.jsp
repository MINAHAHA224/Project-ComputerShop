...
<%--src/main/webapp/WEB-INF/view/admin/product/create.jsp--%>
        ...
        <head>
            ...
            <title>Thêm Sản Phẩm Mới - 3TLap Admin</title>
            ...
            <style>
                ...
                .avatar-preview-create {
                 ...
                 body.theme-dark .avatar-preview-create {
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            <h1 class="main-content-title mt-4">Thêm Sản Phẩm Mới</h1>
                            ...
                            <div class="card admin-form-card">
                                ...
                                <div class="card-body">
                                    <form:form method="post" action="/admin/product/create" modelAttribute="productCreateRqDTO" enctype="multipart/form-data">
                                        <security:csrfInput />
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <form:input type="number" step="1000" min="0" path="price" cssClass="form-control" id="price"/>
                                                        <form:errors path="price" cssClass="form-error"/>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="shortDesc" class="form-label">Mô tả ngắn <span class="text-danger">*</span></label>
                                                    <form:textarea path="shortDesc" cssClass="form-control" id="shortDesc" rows="3"/>
                                                    <form:errors path="shortDesc" cssClass="form-error"/>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="detailDesc" class="form-label">Mô tả chi tiết <span class="text-danger">*</span></label>
                                                    <form:textarea path="detailDesc" cssClass="form-control" id="detailDesc" rows="6"/>
                                                    <form:errors path="detailDesc" cssClass="form-error"/>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-4 mb-3">
                                                        <label for="quantity" class="form-label">Số lượng tồn <span class="text-danger">*</span></label>
                                                        <form:input type="number" min="0" path="quantity" cssClass="form-control" id="quantity"/>
                                                        <form:errors path="quantity" cssClass="form-error"/>
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <label for="factory" class="form-label">Hãng sản xuất <span class="text-danger">*</span></label>
                                                        <form:select path="factory" cssClass="form-select" id="factory">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <label for="target" class="form-label">Đối tượng sử dụng <span class="text-danger">*</span></label>
                                                        <form:select path="target" cssClass="form-select" id="target">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 text-center">
                                                    <label class="form-label d-block">Ảnh sản phẩm <span class="text-danger">*</span></label>
                                                    <div class="avatar-preview-container">
                                                        <img src="<c:url value='/images/product/default-product.png'/>" 
                                                             alt="Xem trước ảnh sản phẩm"
                                                             id="productImagePreview" class="avatar-preview-create">
                                                    </div>
                                                    <label for="productImageFile" class="custom-file-upload-admin btn btn-sm btn-outline-secondary">
                                                        <i class="fas fa-upload"></i> Tải ảnh lên
                                                    </label>
                                                    <input class="form-control d-none" type="file" name="avatarFile" id="productImageFile" accept="image/png, image/jpeg, image/gif, image/webp" onchange="previewAvatarAdmin(event, 'productImagePreview')">
                                                    <p class="text-muted small mt-1">PNG, JPG, GIF, WEBP (Tối đa 5MB)</p>
                ...
                function previewAvatarAdmin(event, previewElementId) {
                    ...
                    if (fileInput.files && fileInput.files[0]) {
                        ...
                        if (file.size > 5 * 1024 * 1024) {
                            ...
                            fileInput.value = "";
                            output.src = "<c:url value='/images/product/default-product.png'/>";
                            return;
                        }
