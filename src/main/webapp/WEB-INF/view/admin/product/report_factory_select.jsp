<%--src/main/webapp/WEB-INF/view/admin/product/report_factory_select.jsp--%>
...
<head>
    ...
    <style>
        .form-container { padding: 20px; max-width: 500px; margin: 50px auto; border: 1px solid #ddd; border-radius: 5px; }
        .form-group { margin-bottom: 15px; }
        .form-group label { display: block; margin-bottom: 5px; }
        .form-group select, .form-group button { padding: 8px 12px; border-radius: 4px; border: 1px solid #ccc; }
            ...
            <div class="container-fluid px-4">
                ...
                <div class="form-container">
                    <form action="<c:url value='/admin/product/report/excel/preview'/>" method="get">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">Xem Trước Báo Cáo</button>
                        </div>
                    </form>
                </div>
            </div>
