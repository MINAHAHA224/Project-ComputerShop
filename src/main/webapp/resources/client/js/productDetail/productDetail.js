(function ($) {
    ...
    $(document).ready(function () {
        ...
        if (navElement.length) { // Kiểm tra navElement có tồn tại không
            ...
            navElement.find('a.nav-link').each(function () {
                ...
                if (href && (currentUrl === href || currentUrl.startsWith(href + '/'))) {
                    if (href === "/" && currentUrl !== "/") { // Tránh active trang chủ khi ở trang con
    ...
    $('#btnFilter').click(function (event) {
        ...
        if (typeof sortValue === 'undefined') { // Nếu không có radio nào được chọn
